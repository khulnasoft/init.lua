...
--- @class _247.window.Module
--- @field active_windows _247.window.Window[]
local M = {
  active_windows = {},
}
local nsid = vim.api.nvim_create_namespace("247.window.error")
local nvim_win_is_valid = vim.api.nvim_win_is_valid

--- @class _247.window.Config
--- @field width number
--- @field height number
--- @field row number?
--- @field col number?
...
--- @class _247.window.Window
--- @field config _247.window.Config
--- @field win_id number
--- @field buf_id number
...
--- @param config _247.window.Config
---@diagnostic disable-next-line: undefined-doc-name
--- @param win_config vim.api.keyset.win_config
--- @return _247.window.Window
...
--- @param window _247.window.Window
...
function M.display_error(error_text)
  ...
  table.insert(
    lines,
    1,
    "247: Fatal operational error encountered (error logs may have more in-depth information)"
  )
...
local function set_defaul_win_options(win, name)
  ...
  vim.bo[win.buf_id].filetype = "247"
...
local function highlight_rules_found(win, rules, group)
  local rule_nsid = vim.api.nvim_create_namespace("247.window.rules")
...
function M.capture_input(opts)
  ...
  set_defaul_win_options(win, "247-prompt")
  vim.api.nvim_set_current_win(win.win_id)

  local group = vim.api.nvim_create_augroup(
    "247_present_prompt_" .. win.buf_id,
    { clear = true }
  )
