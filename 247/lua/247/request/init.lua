--- @alias _247.Request.State "ready" | "calling-model" | "parsing-result" | "updating-file" | "cancelled"
--- @alias _247.Request.ResponseState "failed" | "success" | "cancelled"

local Providers = require("247.providers")

--- @class _247.Request.Opts
--- @field model string
--- @field tmp_file string
--- @field provider _247.Providers.BaseProvider?
--- @field xid number

--- @class _247.Request.Config
--- @field model string
--- @field tmp_file string
--- @field provider _247.Providers.BaseProvider
--- @field xid number
...
--- @class _247.Request
--- @field context _247.RequestContext
--- @field state _247.Request.State
--- @field provider _247.Providers.BaseProvider
...
function Request.new(context)
  local provider = context._247.provider_override or Providers.OpenCodeProvider
  return setmetatable({
    context = context,
    provider = provider,
    state = "ready",
...
function Request:start(observer)
  self.context._247:track_request(self.context)
