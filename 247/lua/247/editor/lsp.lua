...
---
--- @param node _247.treesitter.Node The treesitter node to convert
...
---
--- @param require_path string The Lua require path (e.g., "247.logger.logger")
...
--- @class Lsp
--- @field config _247.Options Configuration options for the LSP client
local Lsp = {}
Lsp.__index = Lsp

--- Creates a new Lsp instance with the given configuration.
---
--- @param config _247.Options The configuration options
...
---
--- @param require_path string The Lua require path (e.g., "247", "247.logger.logger")
...
Lsp.stringify_module_exports("247.editor.lsp", function(res)
  print(res)
end)
