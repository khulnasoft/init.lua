...
--- @class _247.treesitter.TSNode
--- @field start fun(): number
--- @field end_ fun(): number

--- @class _247.treesitter.Node
--- @field start fun(self: _247.treesitter.Node): number, number, number
--- @field end_ fun(self: _247.treesitter.Node): number, number, number
--- @field named fun(self: _247.treesitter.Node): boolean
--- @field type fun(self: _247.treesitter.Node): string
--- @field range fun(self: _247.treesitter.Node): number, number, number, number

local M = {}

local function_query = "247-function"
local imports_query = "247-imports"
local fn_call_query = "247-fn-call"
...
--- @param cursor _247.Point
--- @return _247.treesitter.TSNode | nil
...
--- @class _247.treesitter.Function
--- @field function_range _247.Range
--- @field function_node _247.treesitter.TSNode
--- @field body_range _247.Range
--- @field body_node _247.treesitter.TSNode
local Function = {}
...
--- @param ts_node _247.treesitter.TSNode
---@param cursor _247.Point
---@param context _247.RequestContext
---@return _247.treesitter.Function
