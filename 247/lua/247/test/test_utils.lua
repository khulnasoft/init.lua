...
--- @class _247.test.ProviderRequest
--- @field query string
--- @field request _247.Request
--- @field observer _247.Providers.Observer?
--- @field logger _247.Logger

--- @class _247.test.Provider : _247.Providers.BaseProvider
--- @field request _247.test.ProviderRequest?
local TestProvider = {}
...
--- @param status _247.Request.ResponseState
--- @param result string
