--- @class _247.Providers.Observer
--- @field on_stdout fun(line: string): nil
--- @field on_stderr fun(line: string): nil
--- @field on_complete fun(status: _247.Request.ResponseState, res: string): nil

--- @type _247.Providers.Observer
...
--- @class _247.Providers.BaseProvider
--- @field _build_command fun(self: _247.Providers.BaseProvider, query: string, request: _247.Request): string[]
--- @field _get_provider_name fun(self: _247.Providers.BaseProvider): string
local BaseProvider = {}

--- @param request _247.Request
...
--- @param query string
--- @param request _247.Request
--- @param observer _247.Providers.Observer?
...
--- @class OpenCodeProvider : _247.Providers.BaseProvider
...
--- @class ClaudeCodeProvider : _247.Providers.BaseProvider
...
--- @class CursorAgentProvider : _247.Providers.BaseProvider
